...
import { Save, Users, Info, Shield, BookOpen } from 'lucide-react';
...
import { ArchiveConfigTutorial } from '@/components/ArchiveConfigTutorial';
    ...
    <div className="container max-w-4xl mx-auto px-6 py-8">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-muted-foreground mt-1">系统功能与规则配置</p>
        </div>
      ...
      <Tabs defaultValue="analysis" className="space-y-6">
        <TabsList>
          <TabsTrigger value="analysis">群分析配置</TabsTrigger>
          <TabsTrigger value="archiving">会话存档设置</TabsTrigger>
        </TabsList>
            ...
            <div className="space-y-6 max-w-2xl">
              <div className="grid gap-2">
                <div className="flex items-center">
                  <div className="w-24 shrink-0 text-right mr-4">
                    <span className="text-red-500 mr-1">*</span>
                    <Label>企业ID</Label>
                  </div>
                  <Input
                    placeholder="请输入"
                    value={archiveConfig.enterpriseId}
                    onChange={(e) => setArchiveConfig({ ...archiveConfig, enterpriseId: e.target.value })}
                  />
                </div>
              </div>
              ...
              <div className="grid gap-2">
                <div className="flex items-center">
                  ...
                  <Input
                    placeholder="请输入"
                    value={archiveConfig.chatSecret}
                    onChange={(e) => setArchiveConfig({ ...archiveConfig, chatSecret: e.target.value })}
                  />
                </div>
              </div>
              ...
              <div className="grid gap-2">
                <div className="flex items-center">
                  ...
                  <Input
                    placeholder="请配置"
                    value={archiveConfig.privateKey}
                    onChange={(e) => setArchiveConfig({ ...archiveConfig, privateKey: e.target.value })}
                  />
                </div>
              </div>
              ...
              <div className="grid gap-2">
                <div className="flex items-center">
                  ...
                  <Input
                    placeholder="请配置"
                    value={archiveConfig.version}
                    onChange={(e) => setArchiveConfig({ ...archiveConfig, version: e.target.value })}
                  />
                </div>
              </div>
            </div>
